...
@CommandParameters(description = "Potato for everyone ;)", usage = "/<command>")

public class Command_potato extends TFM_Command

{

    public static final String POTATO_LYRICS = "Potato, Potato, eat the potato";
...

    {
        ...
        heldItemMeta.setDisplayName((new StringBuilder()).append(ChatColor.WHITE).append("Sometimes ").append(ChatColor.DARK_GRAY).append("Sad").toString());
